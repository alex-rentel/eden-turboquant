...
## Speed (K4/V2, decode 50 tokens, fused Metal kernels)
...
Remaining overhead is MLX per-operation dispatch (0.25ms/op × 70 concat ops/step). Requires fused attention-from-compressed kernel to eliminate.
